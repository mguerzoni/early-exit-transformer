...
from conf import *
import torchaudio
from util.data_loader import collate_fn, collate_padding_fn
'''
...
train_dataset1 = torchaudio.datasets.LIBRISPEECH("/stek/data/corpora", url="train-clean-100", download=True)
#train_dataset2 = torchaudio.datasets.LIBRISPEECH("/stek/data/corpora", url="train-clean-360", download=True)
#train_dataset3 = torchaudio.datasets.LIBRISPEECH("/stek/data/corpora", url="train-other-500", download=True)
