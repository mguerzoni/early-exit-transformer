...
if bpe_flag== True:
    ...
    '''
    decoder=[]
    for w_ins in [0,-1,-1,-1,-2,-2]: #valori positivi aumentano le inserzioni --- su 100 ore
    #for w_ins in [0,0,0,0,0,0]: #valori positivi aumentano le inserzioni --- corretto sulle 1000 ore
...
def avg_models(model, path, init, end):
    ...
    best_model=path+'mod-w2-{:03d}-transformer'.format(nepoch)
